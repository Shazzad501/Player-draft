...
const Footer = () => {
  return (
    <div className="bg-[#06091A] text-white flex flex-col items-center justify-center gap-7 mt-72 lg:mt-56">
      {/* newsletter section */}
      <div className="p-2 rounded-lg border-2 border-white bg-transparent w-11/12 mx-auto lg:-mt-36 -mt-48">
        <div className="bg-white text-black rounded-xl">
          <div className="footer text-center flex flex-col items-center justify-center gap-4 py-16 rounded-xl">
            ...
            <input type="email" placeholder="Enter your email:" className="bg-white border-2 text-black text-base p-2 rounded-md w-[85%]"/>
      ...
      <div>
        <h2 className="font-bold text-sm mb-5">@2025 Shazzad Maruf All Rights Reserved.</h2>
      </div>
    </div>
  );
};
